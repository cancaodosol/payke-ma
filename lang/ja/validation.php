...
return [
    ...
    */
    ...
    "are_you_sure_you_want_to_delete_member" => "本当にこのチームからチームメンバーを削除しますか？",
    "are_you_sure_you_want_to_delete_team" => "本当にこのチームを削除しますか？",
    "are_you_sure_you_want_to_leave_team" => "本当にこのチームから脱退しますか？",
    ...
    "country" => ":Attributeには、存在する国を指定してください。",
    "create_team" => "チームを作成する。",
    "current_password" => "パスワードが正しくありません。",
    "current_teams" => "現在のチーム",
    ...
    "if_you_delete_team_all_data_will_be_deleted" => "チームを削除すると、チームに関連する全てのデータも削除されます。",
    ...
    "leave_team" => "チームを脱退する。",
    "looks_like_you_are_not_part_of_team" => "あなたはどこのチームにも所属していないようです。",
    ...
    "next" => "次へ &raquo;",
    "not_eligible_based_on_current_members_teams" => "チーム数/チームメンバー数がこのプランの利用資格を満たしていません。",
    ...
    "plan_allows_no_more_teams" => "現在のプランでは、これ以上チームを作成することができません。",
    "please_upgrade_to_add_more_members" => "チームメンバーを更に追加する場合は、サブスクリプションを更新してください。",
    "please_upgrade_to_create_more_teams" => "チームを更に作成する場合は、サブスクリプションを更新してください。",
    ...
    "slug_input_explanation" => "このスラッグは、あなたのチームを識別するためにURLで使用されます。",
    "starts_with" => ":Attributeは、次のいずれかで始まる必要があります。:values",
    "state" => "この都市は、指定された国では無効です。",
    "string" => ":Attributeには、文字列を指定してください。",
    "team" => "チーム",
    "team_billing" => "チームの請求",
    "team_members" => "チームメンバー",
    "team_name" => "チーム名",
    "team_name_was_updated" => "チーム名が更新されました。",
    "team_photo" => "チーム写真",
    "team_profile" => "チームプロフィール",
    "team_settings" => "チーム設定",
    "team_slug" => "チームスラッグ",
    "team_trial" => "チームトライアル",
    "team_trial_will_expire_on" => "チームトライアルは、:dateに有効期限切れになります。",
    "teams" => "チーム",
    "teams_currently_trialing" => "現在トライアル中のチーム",
    ...
    "update_team_name" => "チーム名を更新します。",
    "uploaded" => ":Attributeのアップロードに失敗しました。",
    "uppercase" => ":Attributeは、大文字で入力してください。",
    "url" => ":Attributeは、有効なURL形式で指定してください。",
    "user" => "このメールアドレスに一致するユーザーがいません。",
    "user_already_invited_to_team" => "そのユーザーは既にチームに招待済です。",
    "user_already_on_team" => "そのユーザーは既にチームメンバーです。",
    "user_doesnt_belong_to_team" => "そのユーザーは、チームに加入していません。",
    "user_invited_to_join_team" => ":UserNameがあなたをチームに勧誘しています！",
    "uuid" => ":Attributeは、有効なUUIDである必要があります。",
    "vat_id" => "この付加価値税(VAT)識別番号は無効です。",
    "view_all_teams" => "全てのチームを閲覧する。",
    "we_found_invitation_to_team" => ":TeamNameチームへの招待を受け取りました！",
    "wheres_your_team" => "あなたはどのチームに所属していますか？",
