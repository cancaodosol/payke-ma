<div class="sm:grid sm:grid-cols-6 sm:items-start sm:gap-4 sm:py-3">
    ...
    <div class="mt-2 sm:col-span-2 sm:mt-0">
        <select id="{{ $name }}" name="{{ $name }}" autocomplete="{{ $name }}" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
