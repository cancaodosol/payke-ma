<div class="sm:grid sm:grid-cols-6 sm:items-start sm:gap-4 sm:py-3">
    ...
    <div class="mt-2 sm:col-span-3 sm:mt-0">
        ...
        @if($addRandamBtn ?? false)
            <button id="randam_btn_{{ $name }}" title="{{ $addRandamBtn }}" onClick="return false;" class="inline-flex justify-center text-xs bg-yellow-200 hover:bg-gray-100 text-gray-900 font-semibold px-3 py-2 border border-gray-300 rounded-lg shadow">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4">
