            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr>
                        ...
                        <div hidden>{{ $payke_app_url = 'https://'.$user->PaykeHost->hostname.'/'.$user->user_app_name.'/admin/users'; }}</div>
                        <td class="whitespace-nowrap px-2 py-2 text-sm text-gray-900"><a href="{{ $payke_app_url }}" target="_blank" rel="noopener noreferrer">{{ $payke_app_url }}</a></td>
                        ...
                        <td class="whitespace-nowrap px-2 py-2 text-sm font-medium text-gray-900">{{ $user->PaykeResource->payke_name }}</td>
