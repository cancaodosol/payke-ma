<x-layouts.basepage title="Payke環境 新規作成" current="新規作成">
    ...
    <div class="space-y-12 sm:space-y-16">
        ...
        <div class="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
            ...
            <input type="hidden" name="user_app_name" value="{{ $user->user_app_name }}"/>
            <x-forms.input name="__user_app_name" value="{{ $user->user_app_name }}" label="公開アプリ名" disabled="true" example="例) tarotaro7" pattern="^[0-9a-zA-Z]+$" explain="この名前が、サブディレクトリ名となります。英数字のみ使用可能です。"/>
